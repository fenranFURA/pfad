...
paddle_width = 100
paddle_height = 100
enlargement_paddle_width = 105
reduction_paddle_height = 105
            ...
            if (brick_x - ball_x) ** 2 + (brick_y - ball_y) ** 2 <= (brick_radius + 15) ** 2:
                ...
                if paddle_change_interval == 0:
                    ...
                    if resize_action == "enlarge":
                        ...
                        paddle_image = pygame.image.load(filePath).convert_alpha()
                        paddle_image = pygame.transform.scale(paddle_image, (paddle_width, paddle_height))
                        paddle_image = pygame.transform.scale(paddle_image, (int(paddle_image.get_width() * 1.5), paddle_image.get_height()))
                    elif resize_action == "shrink":
                        filePath = "reduction.png"
                        paddle_image = pygame.image.load(filePath).convert_alpha()
                        paddle_image = pygame.transform.scale(paddle_image, (paddle_width, reduction_paddle_height))
                        paddle_image = pygame.transform.scale(paddle_image, (int(paddle_image.get_width() * 0.67), paddle_image.get_height()))
                    else:
                        filePath = "path_to_your_paddle_image.png"
                        paddle_image = pygame.image.load(filePath).convert_alpha()
                        paddle_image = pygame.transform.scale(paddle_image, (paddle_width, paddle_height))
